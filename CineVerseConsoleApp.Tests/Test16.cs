...
namespace CineVerseConsoleApp.Tests
{
    ...
    {
        [TestCase]
        public void CannotUpdatedMovieGenreId()
        {
            int id = 1;
            int newGenreId = 3;
            ...
            /* 
            * Ensure that trying to update the movie genre id does not throw an exception,
            * but it prints "Movie not found!" to the console 
            */
            Assert.DoesNotThrow(() => updateMovieBusiness.UpdateMovieDuration(id, newGenreId));
        }
    }
}
